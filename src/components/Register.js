...
function Register({currentStep,gotoLastStep,newUserDetails,intilisePersonalInfo,initialPaymentInfo}) {
...
const mapDispatchToProps = dispatch => {
    ...
    return ({
        gotoLastStep: step => dispatch(setRegisterStep(step)),
        intilisePersonalInfo:userInfo=>dispatch(addPersonalInfo({})),
        initialPaymentInfo:info=>dispatch(addPaymentInfo({}))
    })
}
